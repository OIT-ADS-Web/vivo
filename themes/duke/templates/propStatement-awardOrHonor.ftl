...
<#macro showAward statement>
  <#local linkedIndividual>
    <#if statement.awardReceipt??>
      <a href="${profileUrl(statement.uri("awardReceipt"))}" data-uri="${statement.uri("award")}" data-label="${statement.awardLabel!statement.awardLabel!}" title="award name">${statement.awardLabel!}</a>
    <#else>
