...
<section id="terms" role="region">
  ...
  <p>i. query the API;</p>
  <p>ii. download resulting aggregated output to view and use for personal and scholarly uses;</p>
  ...
  <p>iv. make any use, display, performance, reproduction, or distribution that exceeds or violates these Terms and Conditions of Use.</p>
  <p>v. make any commercial use of the API or contents obtained by the API;</p>
...
<ul class="section-navigation">
  <li class="section-collapsible" id="OldTerms">
    <a name="OldTerms" 
       class="expanderLink" 
