...
public class PublicationAuthorsCustomFields extends DukeJSONContextNodeFields {
    ...
    public PublicationAuthorsCustomFields(RDFServiceFactory rdfServiceFactory){                
